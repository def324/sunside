...
The README can embed an animated demo at:

- `docs/images/demo.webp` (preferred, high quality)
- `docs/images/demo.gif` (fallback)

These files are generated by the manual GitHub Actions workflow `Generate demo media` (`.github/workflows/demo-gif.yml`). Run it after major UI changes that affect layout or animation.
