...
This file is generated by the manual GitHub Actions workflow `Generate demo media` (`.github/workflows/demo-gif.yml`). Run it after major UI changes that affect layout or animation.
